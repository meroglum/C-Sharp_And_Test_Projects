...
namespace _2023._01._25LinqApp
{
    ...
    public static partial class LinqMethods
    {
        ...
        /// Filter successfull.
        /// </summary>
        public static IEnumerable<Ogrenci> GetPassedStudends()
        {
            OgrenciData ogrenciData = new OgrenciData(); ///Todo do not call this on all methods
            var basariliOgrenciler = ogrenciData.OgrenciListesi.Where(Ogrenci => Ogrenci.NotOrtalaması >= 50.0);
            ...
            return basariliOgrenciler;
        }

        /// <summary>
        /// Filter failed students.
        /// </summary>
        public static IEnumerable<Ogrenci> GetFailedStudends()
        {
            OgrenciData ogrenciData = new OgrenciData(); ///Todo do not call this on all methods
            var kalanOgrenciler = ogrenciData.OgrenciListesi.Where(Ogrenci => Ogrenci.NotOrtalaması < 50);
